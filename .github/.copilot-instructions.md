...
- Don't over-explain basic concepts unless specifically asked. Focus on practical code examples and best practices relevant to the context provided.
- Do not generate documentation in Markdown format unless specifically requested.
- Keep the code concise and relevant to the context.
- Verbose explanations should be avoided unless necessary for clarity.
- Verbose code is considered bad practice; prefer concise and efficient solutions. Especially self-explanatory code is preferred.
